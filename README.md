# CSV Business Analyst with LangChain Tools, FastAPI, React, PostgreSQL, Docker - Advanced LangChain tool-calling agent

## Project Overview

CSV Business Analyst with LangChain Tools, FastAPI, React, PostgreSQL, Docker - Advanced LangChain tool-calling agent is a complete full-stack AI project for **LangChain tool-calling agent** at **Advanced** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.
...
```text
ai-langchain-tool-calling-agent-csv-business-analyst-with-langchain-tools-fastapi-react-po/
  backend/
    app/
      main.py
      config.py
...
- `project_type`: `LangChain tool-calling agent`

## How The RAG/Agent Flow Works

LangChain-style tools for calculator, CSV summary, and document search routed by the agent.
